 ...
 async  ngOnInit() {
    ...
    if (this.type === 'edit') {
      const {  userName, userType_Id, name,
        ...
        Validation.match(this.formNewUser.controls['password'].value,this.formNewUser.controls['confirmPassword'].value)
        this.formNewUser.controls['password'].setValidators([ Validators.required, Validators.minLength(6), Validators.maxLength(40)])
        this.formNewUser.controls['confirmPassword'].setValidators([ Validators.required, Validators.minLength(6), Validators.maxLength(40)]);
  ...
  editUser(): void {
    ...
    if(this.formNewUser.controls['password'].value !== this.formNewUser.controls['confirmPassword'].value){
