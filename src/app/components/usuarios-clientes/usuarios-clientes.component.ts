...
export class UsuariosClientesComponent implements OnInit {
  ...
  constructor( public dialog: MatDialog, private backEndServices: ServicesBackendService, private _snackBar: MatSnackBar, private _AESEncryptDecryptService: AESEncryptDecryptServiceService,
    ) { }

  userRole = this._AESEncryptDecryptService.urol();
